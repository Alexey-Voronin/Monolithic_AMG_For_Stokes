...
all_problems = dict.fromkeys(['structured/2D_bfs/','unstructured/2D/',
                              'structured/3D/', 'unstructured/3D/',
                             ], None)
...
for r, axs in enumerate(axs_all):
    ...
    for (i, data_dict), data in zip(enumerate(all_problems.values()), all_problems.values()):
...
axs_all[0,0].legend(loc='lower left',
