...
def get_mg_params(msh_type, disc_type, dim, mg_type):
    ...
    assert disc_type in [('CG', 'CG')], f'discretization is wron: {str(disc_type)}'
    ...
    lsc_dgs_outer_params = deepcopy(lsc_dgs_params)
    ################################################################
    ...
    mg_params = {
                     ...
                     'wrapper_params'    : {'relax_params' : ('lsc', lsc_dgs_outer_params),
                                            'tau' : tau,
                                            'eta' : eta,
                                            },
                     'levels'            : 10,
